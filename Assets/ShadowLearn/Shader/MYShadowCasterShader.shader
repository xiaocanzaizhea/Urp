Shader "Lit_Learn/MYShadowCasterShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            TEXTURE2D_SHADOW(_LightDepthTexture);SAMPLER_CMP(sampler_LightDepthTexture);
            ...
            Varings vert (Attributes v)
            {
            	...
            	o.shadowCoord2 = mul(_worldToLightClipMat,float4(vertexinput.positionWS,1));
            ...
            half4 frag (Varings i) : SV_Target
            {
            	...
            	float shadow2 = SampleShadowmap(TEXTURE2D_ARGS(_LightDepthTexture, sampler_LightDepthTexture),i.shadowCoord2, shadowSamplingData, shadowParams, false);
...
//ShadowCaster
        Pass
        {
            ...
            #include "Assets/ShadowLearn/Shader/LitShadowLearnCommon.hlsl"
            ENDHLSL
        }
    }
}